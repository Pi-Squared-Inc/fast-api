...
const CHAIN_OPTIONS: ChainOption[] = [
  { label: 'Fast', value: 'fast', token: 'SETUSDC', sampleReceiver: 'fast1rv8wsdd5pnkwt4u637g2yj4tpuyq26rzw8380rfhpnsnljz7v3tqv4njuq' },
  ...
  const agentActions = useMemo<ApiActionCardProps[]>(() => [
    {
      ...
      failureExamples: [
        {
          payload: { error: 'Invalid address for chain fast: fast1...', code: 'INVALID_ADDRESS' },
